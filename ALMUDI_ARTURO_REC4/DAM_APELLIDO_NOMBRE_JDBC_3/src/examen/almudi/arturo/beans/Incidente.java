...
public class Incidente {
    ...
    public String getCodigoIncidente() { return codigoIncidente; }
    public void setCodigoIncidente(String codigoIncidente) { this.codigoIncidente = codigoIncidente; }
    ...
    public Soc getSoc() { return soc; }
    public void setSoc(Soc soc) { this.soc = soc; }

    public InformeIncidente getInforme() { return informe; }
    public void setInforme(InformeIncidente informe) { this.informe = informe; }
